...
public class Calculation 
{
    ...
    private int id;
    private double salary,hra,da,ta,it,pf;
    private String contact,email;
    private String myconnection;
    private double salaryTDS,salarywithoutTDS;
    private String msg;
        ...
        try
        {
            ...
            rs.last();
                if(rs.getRow()==0)
                {
                    ...
                    st.setString(10,String.valueOf(it));
                    st.setString(11,String.valueOf(pf));
                    st.setString(12,String.valueOf(salaryTDS));
                    st.executeUpdate();
    ...
    public double getSalaryTDS() {
        this.salaryTDS=salary+(hra+da+ta-it-pf)*(salary/100);
        return salaryTDS;
    }

    public void setSalaryTDS(double salaryTDS) {
        
        this.salaryTDS = salaryTDS;
