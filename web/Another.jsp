<%-- 
    Document   : Another
    Created on : Sep 15, 2017, 12:59:27 PM
    Author     : vkunal1996
--%>
...
<html>
    ...
    <div>
        ...
        <center>
                <jsp:useBean id="obj" class="myCalculation.Calculation1">
         ...
         <tr><th>   Employee Total Salary:</th><td><jsp:getProperty name="obj" property="salarywithoutTDS"/></td></tr>
